...
export async function populateInitialData() {
    ...
    const menuItems = [
        ...
        { id: 'ruby_tea', name: '18號紅玉', price: 60, category: '飲品', sortOrder: 23, imageUrl: '/images/ruby_tea.jpg' },
        { id: 'osmanthus_oolong', name: '桂花烏龍茶', price: 60, category: '飲品', sortOrder: 24, imageUrl: '/images/osmanthus_oolong.jpg' },
        { id: 'rose_fruit', name: '玫瑰雙果茶', price: 65, category: '飲品', sortOrder: 25, imageUrl: '/images/rose_fruit.jpg' },
        { id: 'americano', name: '美式咖啡', price: 70, category: '飲品', sortOrder: 26, imageUrl: '/images/americano.jpg' },
        { id: 'latte', name: '拿鐵咖啡', price: 90, category: '飲品', sortOrder: 27, imageUrl: '/images/latte.jpg' },
        { id: 'coke', name: '可樂', price: 40, category: '飲品', sortOrder: 28, imageUrl: '/images/coke.jpg' },
        { id: 'sprite', name: '雪碧', price: 40, category: '飲品', sortOrder: 29, imageUrl: '/images/sprite.jpg' },
        { id: 'soymilk', name: '豆奶', price: 30, category: '飲品', sortOrder: 30, imageUrl: '/images/soymilk.jpg' },

        // 📦 冷凍包
        { id: 'frozen_beef', name: '紅燒牛腩筋-冷凍包', price: 380, category: '冷凍包', stock: 30, sortOrder: 31, imageUrl: '/images/frozen_beef.jpg' },
        { id: 'frozen_pork', name: '無錫排骨-冷凍包', price: 380, category: '冷凍包', stock: 30, sortOrder: 32, imageUrl: '/images/frozen_pork.jpg' },
        { id: 'frozen_chicken_soup', name: '陳年菜脯雞湯-冷凍包', price: 220, category: '冷凍包', stock: 30, sortOrder: 33, imageUrl: '/images/frozen_chicken_soup.jpg' },
        { id: 'frozen_goulash', name: '匈牙利牛肉湯-冷凍包', price: 240, category: '冷凍包', stock: 30, sortOrder: 34, imageUrl: '/images/frozen_goulash.jpg' },
    ...
    for (const item of menuItems) {
        const isStockItem = item.category === '冷凍包' && item.stock !== undefined; 
        await store.put({
            id: item.id,
            name: item.name,
